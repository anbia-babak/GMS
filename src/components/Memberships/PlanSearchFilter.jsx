...
function PlanSearchFilter (props){
    // Because the function accepts only one parameter, We are forced
    // to destructure it eventhough plan and onPlanChange are not the props.!!!
const {plan, onPlanChange, id} = props;
    return(
        <div className="relative">
                <select name="plan" id={props.id} value={plan} onChange={(event) => onPlanChange(event.target.value)}
...
export default PlanSearchFilter;